...
export const AWARD_ANIMATION_KEY_MAP: Record<string,AwardKey> = {
  'best-player-match':'best_player','team-match-mvp':'team_match_mvp','tournament-mvp':'best_player','best-team':'best_team','best-club':'best_club','best-referee':'best_referee','fair-play':'fair_play','top-scorer':'top_scorer','top-hitter':'top_hitter','podium':'champion','awards':'champion'
};
