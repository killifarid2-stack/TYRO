...
import { FlagSettingsProvider } from "@/context/FlagSettingsContext";
          ...
          <ErrorBoundary>
            <Suspense fallback={<RouteFallback />}>
              <Routes>
                ...
                <Route path="/flags" element={<FlagsSettingsPage />} />
...
const App = () => (
  <QueryClientProvider client={queryClient}>
    <I18nProvider>
      {/* Flag appearance is global (and mirrored into the separate public
          display window), so it sits above the match/route tree — every
          screen, including the broadcast overlays, reads the same value. */}
      <FlagSettingsProvider>
